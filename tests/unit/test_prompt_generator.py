...
def create_sample_errors() -> List[QualityError]:
    ...
    return [
        ...
        create_sample_error(tool="mypy", code="missing-return-type", message="Missing return type annotation")
    ]
...
class TestPromptGenerator:
    ...
    def test_includes_code_context_in_prompt(self):
        """Test that code context is included in the prompt."""
        from stomper.ai.prompt_generator import PromptGenerator
        ...
        # Test that code context is present
    ...
    def test_includes_full_code_context(self):
        """Test that full code context is included without truncation."""
        from stomper.ai.prompt_generator import PromptGenerator
        ...
        # Should include the full code context
