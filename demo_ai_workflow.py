#!/usr/bin/env python3
"""Demo script showing complete AI workflow with sandbox manager."""
...
def create_broken_project() -> Path:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="stomper_ai_demo_"))
...
def demonstrate_ai_fix(project_path: Path, errors):
    """Demonstrate AI agent fixing errors in sandbox."""
    console.print("\n🤖 [bold green]AI Agent Fixing Errors...[/bold green]")
    ...
    try:
        ...
        # Simulate AI agent making changes
...
"""
        ...
        try:
            ...
            if result.returncode == 0:
                console.print("  ✅ Code runs successfully!")
                console.print(f"  📄 Output: {result.stdout.strip()}")
            else:
                console.print("  ⚠️ Code still has issues:")
...
def main():
    ...
    console.print(Panel.fit(
        "[bold blue]Stomper AI Workflow Demo[/bold blue]\n"
        "This demo shows the complete workflow:\n"
        "1. Find errors in a project\n"
        "2. Create isolated sandbox\n"
        "3. AI agent fixes errors safely\n"
    ...
    try:
        ...
        sandbox_path, branch_name = demonstrate_ai_fix(project_path, errors)
        
        if sandbox_path:
            console.print(Panel.fit(
                "[bold green]✅ AI Workflow Complete![/bold green]\n\n"
                "The AI agent successfully:\n"
                "• Created isolated sandbox environment\n"
                "• Fixed multiple errors across files\n"
